...
interface ToastContextType {
    toast: (props: { title?: string; description?: string; variant?: "default" | "success" | "destructive"; duration?: number }) => void;
}
...
export function ToastProvider({ children }: { children: React.ReactNode }) {
    ...
    const addToast = useCallback(({ title, description, variant = "default", duration = 2500 }: Omit<Toast, "id" | "variant" | "duration"> & { variant?: Toast["variant"], duration?: number }) => {
...
function ToastItem({ id, title, description, variant, duration, onRemove }: ToastItemProps) {
