...
export default function BracketPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const [selectedMatch, setSelectedMatch] = useState<Match | null>(null); // For modal
    ...
    const [confirmState, setConfirmState] = useState<{
        ...
        title?: string;
        description?: string;
    }>({ isOpen: false, type: null, data: null }); // type: 'advance' | 'proceed'
    const [showVictoryModal, setShowVictoryModal] = useState(false);
    const [swissKing, setSwissKing] = useState<Participant | null>(null);
    ...
    return (
        <div className="container mx-auto px-4 py-8 min-h-screen">
                        ...
                        <>
                            <div className="mb-8 overflow-x-auto">
                                <BracketConnector
                                    ...
                                    match_target_points={tournament?.match_target_points ?? 4}
                                />
                            </div>
                            <SwissView
                                matches={matches.filter(m => m.stage === "swiss")}
            ...
            <VictoryModal
                ...
                organizerName={tournament?.store_id || ""}
            />
