...
export function LandingPageClient({ initialStores }: LandingPageProps) {
    const user = useUser();
    const [username, setUsername] = useState<string | null>(null);
    const [isOwner, setIsOwner] = useState(false);

    // Still client-side fetch user details (Profile/Store ownership)
    useEffect(() => {
            ...
            <div className="container mx-auto px-4 py-8 md:py-16 relative flex-1">
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="flex items-center justify-between mb-8">
                        ...
                        <span className="text-sm text-neutral-500">{initialStores.length} found</span>
                    </div>
